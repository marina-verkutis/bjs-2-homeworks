describe('Домашнее задание к занятию 1. «Основные понятия»', () => {
  ...
  describe('Задача №2. Функция должна:', () => {
    ...
    it('воспринимать численные значения полученные в строчном виде', () => {
      expect(calculateTotalMortgage('15', 0, 10000, 36)).toEqual(12479.52);
    }); 

    it('возвращать false при получении нечисленных значений', () => {
      expect(calculateTotalMortgage(15, 0, 'ffdsd', 36)).toEqual(false);
    }); 
  });
});